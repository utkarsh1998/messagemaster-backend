...
exports["default"] = mapToObjectsLegacyBehavior;
var _mapToObjects = _interopRequireDefault(require("./mapToObjects.js"));
...
function mapToObjectsLegacyBehavior(data, schema) {
  ...
  var result = (0, _mapToObjects["default"])(data, schema, _objectSpread(_objectSpread({}, defaultConversionOptions), {}, {
    rowIndexMap: rowMap,
